...
<p align="left">
  Sou estudante de <strong>Análise e Desenvolvimento de Sistemas no IFSP - Campus Cubatão</strong> e especializando em <strong>Inteligência Artificial pelo IFNMG</strong>.
  <br><br>
  Atualmente, atuo no <strong>Hospital Municipal de Cubatão</strong> com foco em suporte de TI, organização de dados administrativos e automação de processos operacionais. Busco constantemente evoluir para me tornar um Engenheiro de IA de alto nível.
</p>
